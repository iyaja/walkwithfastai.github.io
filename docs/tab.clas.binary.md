...
* [`Categorify`](/tab.stats.html#Categorify)
* [`FillMissing`](/tab.stats.html#FillMissing)
* [`Normalize`](https://docs.fast.ai/data.transforms#Normalize)

### Categorify

[`Categorify`](/tab.stats.html#Categorify) will transform columns that are in your `cat_names` into that type, along with label encoding our categorical data. 
