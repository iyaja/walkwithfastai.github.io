...
module.exports = function handleInquirer(isString, dir) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, inquirer.prompt(isNewDirQuestions)];
                case 1:
                    isNewDir = (_a.sent()).isNewDir;
                    if (isNewDir) {
                        questions = __spreadArrays([
                            newDirQuestion
                        ], questions);
                    }
                    return [3 /*break*/, 3];
                ...
                case 3: return [2 /*return*/, new Promise(function (resolve, reject) {
                        inquirer
                            ...
                            resolve(__assign({ isNewDir: isNewDir, newDir: newDir }, answers));
                        })["catch"](function (err) {
                            reject(err);
                        });
                    })];
